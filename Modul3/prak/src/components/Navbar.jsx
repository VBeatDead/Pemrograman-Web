        ...
        <div className="row w-100">
          ...
          <div className="col-6 col-lg-8 d-flex justify-content-center">
            <div className="navbar-nav d-flex align-items-center">
              <Link to="/" className="nav-link text-center" style={{ marginRight: '5px' }}>HOME</Link>
              <Link to="/about" className="nav-link text-center" style={{ marginRight: '5px' }}>ABOUT US</Link>
              <Link to="/contact" className="nav-link text-center" style={{ marginRight: '5px' }}>CONTACT</Link>
            </div>
          </div>
